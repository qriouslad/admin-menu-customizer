...
function amcust_admin_scripts( $hook_suffix ) {
	...
	if ( is_amcust() ) {
		...
		wp_register_script( 'jquery-ui-core', get_site_url() . '/wp-includes/js/jquery/ui/core.js', array( 'jquery' ), AMCUST_VERSION, false );
		wp_enqueue_script( 'jquery-ui-core' );

		wp_deregister_script( 'jquery-ui-mouse' );
		wp_register_script( 'jquery-ui-mouse', get_site_url() . '/wp-includes/js/jquery/ui/mouse.js', array( 'jquery-ui-core' ), AMCUST_VERSION, false );
		wp_enqueue_script( 'jquery-ui-mouse' );

		wp_deregister_script( 'jquery-ui-sortable' );
		wp_register_script( 'jquery-ui-sortable', get_site_url() . '/wp-includes/js/jquery/ui/sortable.js', array( 'jquery-ui-mouse' ), AMCUST_VERSION, false );
		wp_enqueue_script( 'jquery-ui-sortable' );

		wp_deregister_script( 'jquery-ui-draggable' );
		wp_register_script( 'jquery-ui-draggable', get_site_url() . '/wp-includes/js/jquery/ui/draggable.js', array( 'jquery-ui-mouse' ), AMCUST_VERSION, false );
		wp_enqueue_script( 'jquery-ui-draggable' );

		wp_deregister_script( 'jquery-ui-droppable' );
		wp_register_script( 'jquery-ui-droppable', get_site_url() . '/wp-includes/js/jquery/ui/droppable.js', array( 'jquery-ui-draggable' ), AMCUST_VERSION, false );
